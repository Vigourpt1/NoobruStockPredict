...
export function DataInstructions() {
  return (
    <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6">
      <div className="flex items-start">
        ...
        <div>
          ...
          <p className="text-sm text-blue-800 mt-3 mb-2">
            Optional columns for enhanced analysis:
          </p>
          <ul className="list-disc list-inside text-sm text-blue-800 space-y-1">
            <li>Customer ID (for customer behavior analysis)</li>
            <li>Region/Location (for geographical analysis)</li>
            <li>Price (for revenue analysis)</li>
            <li>Promotion Code (for campaign tracking)</li>
          </ul>
